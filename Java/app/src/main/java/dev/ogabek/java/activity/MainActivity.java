...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Feed> getAllFeeds() {
        ...
        //Post
        feeds.add(new Feed(new Post(R.drawable.aziz, "Azizbek", R.drawable.post_1)));
        feeds.add(new Feed(new Post(R.drawable.bogibek, "Bogibek Matyaqubov", R.drawable.post_2)));
        feeds.add(new Feed(new Post(R.drawable.elmurod, "Elmurod Nazirov", R.drawable.post_3)));
        feeds.add(new Feed(new Post(R.drawable.jabbor, "Jabbor", R.drawable.post_4)));
        feeds.add(new Feed(new Post(R.drawable.jonibek, "Jonibek Xolmonov", R.drawable.post_1)));
        feeds.add(new Feed(new Post(R.drawable.ogabekdev, "Ogabek Matyakubov", R.drawable.post_2)));
        feeds.add(new Feed(new Post(R.drawable.shakhriyor, "Shakhriyor", R.drawable.post_3)));
        feeds.add(new Feed(new Post(R.drawable.yahyo, "Yahyo Mahmudiy", R.drawable.post_4)));
        feeds.add(new Feed(new Post(R.drawable.aziz, "Azizbek", R.drawable.post_1)));
        feeds.add(new Feed(new Post(R.drawable.bogibek, "Bogibek Matyaqubov", R.drawable.post_2)));
        feeds.add(new Feed(new Post(R.drawable.elmurod, "Elmurod Nazirov", R.drawable.post_3)));
        feeds.add(new Feed(new Post(R.drawable.jabbor, "Jabbor", R.drawable.post_4)));
